//HERC01H  JOB (COBOL),'HELLO',CLASS=A,MSGCLASS=H,                      00000100
...
//COB.SYSIN DD *                                                        00000700
      ...
      *>                                                                00003800
       PROCEDURE DIVISION.                                              00003900
           DISPLAY 'HELLO!' UPON CONSOLE.                               00004000
           STOP RUN.                                                    00004100
      **                                                                00004200
/*                                                                      00004300
//COB.SYSLIB DD DSNAME=SYS1.COBLIB,DISP=SHR                             00004400
//GO.SYSOUT DD SYSOUT=*,DCB=(RECFM=FBA,LRECL=161,BLKSIZE=16100)         00004500
//GO.SYSIN DD *                                                         00004600
/*                                                                      00004700
//                                                                      00004800
